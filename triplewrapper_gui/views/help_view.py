...
class HelpView(Gtk.Box):
    ...
    def _build_ui(self) -> None:
        ...
        title = Gtk.Label(label="Ayuda y documentación")
        ...
        content.append(self._section(
            "Uso básico",
            "1. Pulsa Abrir archivo o arrastra un comprimido a la ventana.\n"
        ...
        content.append(self._section(
            "Permisos",
            "TripleWrapper es local y sandboxed (Flatpak): sin red y sin "
        ...
        content.append(self._section(
            ...
            "Lectura y escritura: 7z, ZIP, TAR y variantes (GZ, XZ, ZST, "
            "BZ2), Pixz.\n"
        ...
        content.append(self._section(
            "Si algo falla",
            "· La app muestra el motivo en un aviso: sin espacio, sin "
